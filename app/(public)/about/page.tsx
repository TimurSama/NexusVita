...
export default function AboutPage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtitle: 'Выберите текущее состояние',
    },
    {
      id: 'activity',
  ...
  const moods = [
    { id: 'excellent', label: 'Отлично', emoji: '😊', color: 'warmGreen' },
    { id: 'good', label: 'Хорошо', emoji: '🙂', color: 'warmBlue' },
    { id: 'normal', label: 'Нормально', emoji: '😐', color: 'warmGray' },
    { id: 'tired', label: 'Устал', emoji: '😴', color: 'warmPink' },
    { id: 'stressed', label: 'Стресс', emoji: '😰', color: 'warmRed' },
  ]

  const activityLevels = [
    { id: 'low', label: 'Низкая', desc: 'Отдых', icon: '🌙' },
    { id: 'medium', label: 'Средняя', desc: 'Обычный день', icon: '☀️' },
    { id: 'high', label: 'Высокая', desc: 'Активный день', icon: '⚡' },
  ]
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                >
                  ...
                  <p className="text-lg sm:text-xl text-warmGraphite-500 mb-12 max-w-2xl mx-auto">
                    ...
                    единую платформу для управления здоровьем
                  </p>
                </motion.div>
                <motion.div
                  initial={{ y: 20, opacity: 0 }}
                      ...
                      >
                        {moods.map((mood, idx) => (
                          ...
                          >
                            ...
                            <div className="text-sm font-semibold text-warmGraphite-800">
                              {mood.label}
                            </div>
                          </motion.button>
                        ))}
                      ...
                      >
                        {activityLevels.map((level, idx) => (
                          ...
                          >
                            ...
                            <p className="text-sm text-warmGraphite-600">{level.desc}</p>
                            {formData.activityLevel === level.id && (
                              <motion.div
                                initial={{ scale: 0 }}
                                animate={{ scale: 1 }}
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-warmGray-300/50">
                    ...
                    <NeumorphicButton
                      ...
                      disabled={
                        ...
                        (currentStep === 4 && !formData.mood) ||
                        (currentStep === 5 && !formData.activityLevel) ||
                        (currentStep === 6 && !formData.planLevel)
                      }
                      className="text-lg px-8 py-4"
                    >
